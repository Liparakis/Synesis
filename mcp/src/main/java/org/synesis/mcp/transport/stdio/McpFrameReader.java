 ...
 * terminator is received. Clean EOF between frames is distinct from partial EOF, which is a
 * transport failure and must not be treated as graceful shutdown.</p>
 */
