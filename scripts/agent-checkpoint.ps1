...
@("# $cp", "", "- Checkpoint ID: $cp", "- Creation time: $( Get-Date -Format o )", "- Active task: $id", "- Active-task status: $( if ($active.Count -eq 1)
{
  'ACTIVE'
}
else
