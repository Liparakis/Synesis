...
/**
 * Actionable workspace-location guidance returned when a target exists in the control checkout but
 * not in the worker's assigned worktree.
 *
 ...
 * @since 1.0
 */
public record AgentWorkspaceGuidance(String controlCheckout, String assignedWorktree,
                                     String instruction) {
