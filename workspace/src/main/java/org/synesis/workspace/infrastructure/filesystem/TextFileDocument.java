 ...
 * separators, while successful writes restore the document's original newline and BOM policy. Mixed
 * newline files are readable but are conservatively not writable.
 */
