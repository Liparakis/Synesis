...
public final class SessionLeasePolicy {
  ...
  public SessionLeasePolicy() {
    this(Clock.systemUTC(), DEFAULT_HEARTBEAT_INTERVAL, DEFAULT_STALE_THRESHOLD,
   ...
   * @param suspectedStaleThreshold elapsed time after heartbeat when session becomes suspected
   *                                stale
   * @param abandonmentGracePeriod  elapsed time after heartbeat when session becomes abandonment
   *                                eligible
   */
  public SessionLeasePolicy(
      Clock clock,
    ...
    this.suspectedStaleThreshold = Objects.requireNonNull(suspectedStaleThreshold,
        "suspectedStaleThreshold");
    this.abandonmentGracePeriod = Objects.requireNonNull(abandonmentGracePeriod,
