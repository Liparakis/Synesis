...
public final class RetentionPolicy {
  ...
  private static final long DEFAULT_STORAGE_WARNING_THRESHOLD_BYTES =
   ...
   * @param maxDiagnosticAttempts        maximum number of retained diagnostic integration
   *                                     worktrees
  ...
  public RetentionPolicy(
    ...
    this.workerWorktreeRetention = Objects.requireNonNull(workerWorktreeRetention,
        "workerWorktreeRetention");
    ...
    this.temporaryFileRetention = Objects.requireNonNull(temporaryFileRetention,
