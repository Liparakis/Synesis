...
public record ProjectCommandAuthoritySnapshot(
  ...
  public static ProjectCommandAuthoritySnapshot capture(
    ...
    String bindingDigest = digest(java.util.Arrays.asList(
        ...
        binding.provider(),
        binding.providerInstanceFingerprint(), binding.supervisorId(), binding.workerId(),
        binding.worktreeId(),
    ...
    return new ProjectCommandAuthoritySnapshot(bindingDigest, blockerSetDigest, leaseDigest,
        heartbeat,
