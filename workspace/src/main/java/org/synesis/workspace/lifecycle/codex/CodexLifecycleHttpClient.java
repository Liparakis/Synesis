 ...
 * {@link LifecycleControlRequestEnvelope.SignedEnvelope}. A transport retry must call
 * {@link #submit} again with the same immutable envelope; this class does not reconstruct semantic
 * fields or extend its deadline. The client is thread-safe and uses the JDK HTTP client.
 *
 * @since 1.0
 */
