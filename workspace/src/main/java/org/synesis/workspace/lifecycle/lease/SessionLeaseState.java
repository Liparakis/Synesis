...
public enum SessionLeaseState {
  ...
  /**
   * Session process absence is verified beyond the recovery grace period; this only permits fencing
  ...
  /**
   * The server has durably confirmed terminal authority, while the transport has not yet been
   * classified as cleanly closed or abnormally absent.
   */
  TERMINAL_AUTHORITY_CONFIRMED,

  /**
   * Terminal authority was confirmed before the provider transport ended without a clean EOF; this
   * history is not recovery eligible.
   */
