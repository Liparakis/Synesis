...
/**
 * Immutable read-only cleanup plan summarizing discovered lifecycle resources, classifications, and
 ...
 * @param estimatedReclaimableBytes total estimated reclaimable bytes from CLEANUP_ELIGIBLE
 *                                  resources
 * @param diskBudgetWarning         {@code true} if aggregate workspace storage exceeds warning
 *                                  budget
