...
public enum ReconciliationAction {
  ...
  /**
   * Resumes protected fast-forward control-branch advancement for an interrupted successful
   * integration commit.
   */
  ...
  /**
   * Closes an active validation context associated with an abandoned or cancelled requester
   * session.
   */
