...
/**
 * Classifies provider and Synesis administration paths explicitly before a source snapshot is
 * materialized.
 */
public final class SnapshotArtifactPolicy {
   ...
   */
  public record Manifest(List<String> allowedArtifacts, List<String> rejectedArtifacts,
                         String digest) {
    ...
    public Manifest {
      ...
      rejectedArtifacts = List.copyOf(
          Objects.requireNonNull(rejectedArtifacts, "rejectedArtifacts"));
