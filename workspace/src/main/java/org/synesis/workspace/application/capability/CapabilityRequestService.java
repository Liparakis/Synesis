...
public final class CapabilityRequestService {
     ...
     */
    private static CapabilityRequestPayload revisedPayload(CapabilityRequestRecord activeRec, String capability,
            String requesterNode, CapabilityContract contract) {
        return new CapabilityRequestPayload(activeRec.handle(), capability, requesterNode, activeRec.ownerNodeId(),
