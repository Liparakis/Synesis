 ...
 * binding and exact provider thread; it is not a replacement coordination identity.</p>
 *
 ...
 * @param threadId             exact provider thread, or {@code null} while a first generation is
 *                             pending
