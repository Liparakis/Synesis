package org.synesis.workspace.application.guardrail;
...
public final class GuardrailApplicationService {
   ...
   */
  public ActionCheckResult check(Path profile, Path projectRoot, String relativePath,
      String toolName,
      String description) {
   ...
   */
  public record ActionCheckResult(ActionGuardrail.Outcome outcome,
                                  ProjectConstraint matchedConstraint,
                                  String message) {
