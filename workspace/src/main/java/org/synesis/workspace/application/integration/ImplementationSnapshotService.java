...
public final class ImplementationSnapshotService {
  ...
  /**
   * Returns {@code true} if a new publication with the given commit SHA is identical to the most
   ...
   */
  public boolean isIdempotentPublication(ImplementationRevisionRecord existing,
      String newCommitSha) {
