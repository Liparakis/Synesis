...
/**
 * Verifies relay authentication and frame wire vectors without opening a socket.
 */
final class RelayWireCodecTest {

  private static byte[] logicalRecord(NodeIdentity origin, NodeIdentity destination)
      throws GeneralSecurityException {
    return org.synesis.link.overlay.OverlayKeyAgreement.start(UUID.randomUUID(),
        destination.nodeId(),
