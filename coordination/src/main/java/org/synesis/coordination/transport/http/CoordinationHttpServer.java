...
public final class CoordinationHttpServer implements AutoCloseable {
  ...
  /**
   * Creates the existing coordination listener with an optional Codex-only lifecycle route. The
   * handler is injected by the production owner and no provider abstraction is introduced in this
   * coordination module.
   *
   * @param service               coordination service
  ...
  /**
   * Creates the loopback coordination listener with optional lifecycle and versioned local-control
   * handlers.
   *
   * @param service               coordination service
   * @param address               local loopback address
  ...
  /**
   * Creates the loopback coordination listener with optional lifecycle, versioned local-control,
   * and packaged web UI handlers.
   *
   * @param service               coordination service
   * @param address               local loopback address
   * @param codexLifecycleHandler retained Codex handler, or {@code null}
