...
public record OwnershipClaim(UUID taskId, String capability, String ownerNodeId,
  ...
  public static OwnershipClaim decode(byte[] encoded) throws IOException {
    try {
      ...
      OwnershipClaim claim = new OwnershipClaim(taskId, capability, node, supervisor, scopes,
          in.readLong());
      if (in.available() != 0) {
