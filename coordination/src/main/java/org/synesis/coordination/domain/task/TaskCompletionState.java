 ...
 * {@code SNAPSHOT_READY} &rarr; optional review states ({@code REVIEW_PENDING} &rarr;
 * {@code REVIEW_ACCEPTED} or {@code REVIEW_REJECTED}) &rarr; {@code WAITING_FOR_DEPENDENCIES}
 * &rarr; {@code READY_FOR_INTEGRATION} &rarr; {@code INTEGRATING} &rarr; {@code INTEGRATED}. A
 * rejected snapshot is immutable history; a later same-lineage correction publishes a distinct
 * snapshot for the next lane revision. Failure/terminal states: {@code INTEGRATION_FAILED},
