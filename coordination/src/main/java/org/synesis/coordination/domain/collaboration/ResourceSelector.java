...
/**
 * Canonical repository-relative resource selector used for collaboration claims. The first protocol
 * slice supports exact files and directory subtrees only.
 *
