 ...
 * @param authorityLineageId     durable authority lineage for this lane and its authorized
 *                               successors
 ...
 */
public record SnapshotProvenance(UUID workGroupId, UUID laneId, UUID authorityLineageId,
                                 String participant,
                                 String bindingIdentity, long claimEpoch,
                                 List<String> contractRevisions,
  ...
  public SnapshotProvenance(UUID workGroupId, UUID laneId, String participant,
    ...
    this(workGroupId,
        laneId,
        defaultAuthorityLineage(laneId),
        participant,
        bindingIdentity,
        claimEpoch,
        contractRevisions,
