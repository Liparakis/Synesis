 ...
 * {@code AWAITING_OWNER} &rarr; {@code REVISION_REQUESTED} / {@code ACCEPTED} / {@code REJECTED} /
 * {@code CANCELLED} / {@code EXPIRED} / {@code SUPERSEDED}. After acceptance: {@code ACCEPTED}
 * &rarr; {@code IMPLEMENTING} &rarr; {@code IMPLEMENTATION_AVAILABLE} &rarr; {@code VALIDATING}
 * &rarr; {@code VALIDATED}. Validation revision loop: {@code VALIDATING} &rarr;
 * {@code IMPLEMENTING}.
 *
 * @since 1.0
 */
