 ...
 * contains at least 96 bits of cryptographic entropy. Handles do not encode project IDs, worker
 * IDs, prediction IDs, session IDs, branch names, or worktree paths. Possession of a handle locator
 * alone does not grant authorization.
 *
