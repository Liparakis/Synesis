...
/**
 * Signed payload for an authorized unwind of a prepared, unpublished completion. The replacement
 * intent is carried in the same event so replay cannot expose a fenced task with an unowned claim
 * epoch.
 *
