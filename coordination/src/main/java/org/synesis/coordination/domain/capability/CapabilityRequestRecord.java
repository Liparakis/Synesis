...
public record CapabilityRequestRecord(
  ...
  public CapabilityRequestRecord(
    ...
    this(handle, capability, requesterNodeId, "", "", ownerNodeId, "", "",
        unresolvedLineage(handle), contract, state, reason, createdAtEpochMillis,
   ...
   */
  public boolean matchesRequester(String callerNodeId, String callerSupervisorId,
   ...
   */
  public boolean matchesOwner(String callerNodeId, String callerSupervisorId,
      String callerWorkerId) {
