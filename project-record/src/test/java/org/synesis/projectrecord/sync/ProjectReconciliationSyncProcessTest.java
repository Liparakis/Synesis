  ...
  void normalSyncConvergesSuccessfully() throws Exception {
    ...
    try {
      ...
      try {
        ...
        DecisionStore joinStore = new DecisionStore(joinProfile.resolve("records"),
            UUID.fromString(project));
    ...
    try {
      ...
      try {
        ...
        assertTrue(Files.exists(
            hostProfile.resolve("records/conflicts/11111111-1111-1111-1111-111111111111")));
        assertTrue(Files.exists(
            joinProfile.resolve("records/conflicts/11111111-1111-1111-1111-111111111111")));
    ...
    try {
      ...
      try {
        ...
        assertTrue(output.startsWith("false,"),
            "Expected success=false due to corruption. Got: " + output);
