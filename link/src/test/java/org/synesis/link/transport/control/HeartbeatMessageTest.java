...
final class HeartbeatMessageTest {
  ...
  void heartbeatRoundTripUsesStableGoldenBytes() {
    ...
    assertEquals(
        "0100112233445566778899aabbccddeeff000000000000000700000000000000060102030405060708",
        hex(message.encoded()));
  ...
  void acknowledgementRoundTripUsesStableGoldenBytes() {
    ...
    assertEquals(
        "0100112233445566778899aabbccddeeff000000000000000700000000000000090102030405060708",
        hex(message.encoded()));
