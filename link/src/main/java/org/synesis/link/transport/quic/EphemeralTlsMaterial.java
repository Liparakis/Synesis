 ...
 */
public final class EphemeralTlsMaterial implements AutoCloseable {

  private static final String PASSWORD = "synesis-ephemeral";
  /**
   * Temporary directory containing the generated transport keystore.
   */
  public final Path directory;
  /**
   * Generated private key for transport-only TLS.
   */
  public final PrivateKey key;
  /**
   * Generated certificate for transport-only TLS.
   */
  ...
  /**
   * Generates one short-lived transport-only TLS keypair and certificate bundle.
   *
   * @return generated TLS material
   * @throws Exception if key generation or keystore loading fails
   */
  public static EphemeralTlsMaterial create() throws Exception {
    ...
    try {
      ...
      String keytool = Path.of(System.getProperty("java.home"), "bin", executable)
          .toString();
      Process process = new ProcessBuilder(keytool, "-genkeypair", "-alias", "quic", "-keyalg",
          "RSA",
      ...
      return new EphemeralTlsMaterial(directory,
          (PrivateKey) keyStore.getKey("quic", PASSWORD.toCharArray()),
