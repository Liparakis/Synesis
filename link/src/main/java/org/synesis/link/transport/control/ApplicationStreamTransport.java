...
public final class ApplicationStreamTransport {
    ...
    /**
     * Accepts one inbound application stream and replaces the bootstrap handler with the stream owner.
     *
     ...
     */
    public static void accept(ChannelHandlerContext context, ChannelHandler oldHandler, PeerSession session,
