 ...
 */
record HeartbeatMessage(UUID sessionId, long sequence, long relatedSequence, long marker,
                        boolean ack) {

  static final byte VERSION = 1;
  static final int BYTES = 41;

  static HeartbeatMessage heartbeat(UUID sessionId, long sequence, long highestReceived,
      long marker) {
    return create(sessionId, sequence, highestReceived, marker, false);
  }

  static HeartbeatMessage acknowledgement(UUID sessionId, long sequence, long receiverSequence,
      long marker) {
