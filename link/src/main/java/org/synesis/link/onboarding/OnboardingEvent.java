 ...
 * capability and must be handled as user-provided secret material; it is intentionally available to
 * the terminal adapter but never included in exception text.
 *
