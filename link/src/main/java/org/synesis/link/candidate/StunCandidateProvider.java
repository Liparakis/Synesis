 ...
 * mapping to a second UDP socket. Configure it only when the supplied
 * transport is tied to the Link QUIC socket.
 */
public final class StunCandidateProvider implements CandidateProvider {
     ...
     */
    public StunCandidateProvider(InetSocketAddress server, int priority, StunBindingTransport transport) {
