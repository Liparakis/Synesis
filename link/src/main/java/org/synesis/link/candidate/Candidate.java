 ...
 * address representation. Port numbers are in the TCP/UDP range and priority is an unsigned 32-bit
 * ordering value represented by a non-negative Java integer. The diagnostic string intentionally
 * omits the address.
 *
