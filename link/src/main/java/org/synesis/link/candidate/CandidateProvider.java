 ...
 * returned stage completes. The gatherer owns operation deadlines; providers observe the
 * cooperative cancellation token and keep their own cleanup idempotent. Implementations are
 * expected to be thread-safe.</p>
 */
