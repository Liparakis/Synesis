 ...
 * or authentication transcripts. The snapshot is eventually consistent with a concurrently running
 * control stream.</p>
 *
 ...
 * @param estimatedLocalRtt          locally measured echoed-marker round-trip duration, if
 *                                   available
