...
public final class OverlayTopologyView {
    ...
    public synchronized Optional<OverlayTopologyAdvertisement> advertisement(String originNodeId) {
        return Optional.ofNullable(advertisements.get(Objects.requireNonNull(originNodeId, "origin node ID")));
    }
    ...
    /**
     * Returns the default advertisement lifetime used by callers that need a
     * bounded policy value.
     *
