...
public final class OverlayForwardingFrame {
    ...
    private OverlayForwardingFrame(UUID projectId, String destinationNodeId, UUID messageId, int remainingHops,
            byte[] innerRecord) {
     ...
     */
    public static OverlayForwardingFrame create(UUID projectId, String destinationNodeId, UUID messageId,
            int remainingHops, byte[] innerRecord) {
        if (remainingHops <= 0) {
            throw new IllegalArgumentException("new forwarding frame requires a positive hop budget");
        }
        return new OverlayForwardingFrame(projectId, destinationNodeId, messageId, remainingHops, innerRecord);
    }
    ...
    public static OverlayForwardingFrame decode(byte[] bytes) throws IOException {
        ...
        try (DataInputStream input = new DataInputStream(new ByteArrayInputStream(bytes))) {
            ...
            OverlayForwardingFrame result = new OverlayForwardingFrame(project, destination, message, hops, inner);
    ...
    public OverlayForwardingFrame forwardOneHop() {
        ...
        return new OverlayForwardingFrame(projectId, destinationNodeId, messageId, remainingHops - 1, innerRecord);
    }
