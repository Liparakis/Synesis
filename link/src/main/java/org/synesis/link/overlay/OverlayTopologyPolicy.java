 ...
 * circular offsets in the stable node-ID ordering. The policy describes desired direct neighbors;
 * it does not claim that every desired socket is currently reachable.
 */
public final class OverlayTopologyPolicy {
   ...
   */
  public Map<String, List<String>> desiredNeighbors(
      List<OverlayMembershipSnapshot.Member> members) {
   ...
   */
  public List<String> desiredNeighbors(String nodeId,
      List<OverlayMembershipSnapshot.Member> members) {
