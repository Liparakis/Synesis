...
/**
 * Monotonic local read model for the currently accepted signed membership
 * snapshot.
 *
 * <p>The view accepts only a newer snapshot from the same project authority.
 * It does not perform admission, authority succession, revocation workflow, or
...
public final class OverlayMembershipView {
     ...
     * @throws GeneralSecurityException if authority, project, validity, or
     *                                  same-revision contents are invalid
     */
