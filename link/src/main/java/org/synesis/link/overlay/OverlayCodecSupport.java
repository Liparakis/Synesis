...
/**
 * Package-private validation and cryptographic helpers for the overlay wire records.
 */
final class OverlayCodecSupport {
  ...
  static void writeBytes(DataOutputStream output, byte[] bytes, int max, String field)
      throws IOException {
