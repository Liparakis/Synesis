 ...
 * carries the responder's signed candidate descriptor. It is only usable after the offer and the
 * existing Link identity handshake are verified.
 *
 * @since 1.0
 */
public final class TraversalAnswer {
  ...
  private TraversalAnswer(ProtocolVersion protocolVersion, UUID sessionId, byte[] offerDigest,
    ...
    this.responderPublicKey = boundedBytes(responderPublicKey, MAX_KEY_BYTES,
  ...
  public String shareLink() {
    return "synesis://answer/SLA2-" + Base64.getUrlEncoder().withoutPadding()
