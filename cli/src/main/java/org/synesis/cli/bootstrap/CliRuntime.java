 ...
 * @since 1.0
 */
public record CliRuntime(Onboarding onboarding, Terminal terminal,
                         ReadinessInspector readinessInspector,
                         ProjectApplicationService projectService,
                         ConstraintApplicationService constraintService,
                         GuardrailApplicationService guardrailService,
                         HookApplicationService hookService,
   ...
   * @param readinessInspector local readiness inspector
   */
  public CliRuntime(Onboarding onboarding, Terminal terminal,
      ReadinessInspector readinessInspector) {
    this(onboarding, terminal, readinessInspector, new ProjectApplicationService(),
        ...
        new ProviderApplicationService());
  }
  ...
  public static CliRuntime defaults(Terminal terminal) {
    ...
    return new CliRuntime(new Onboarding(profile, renderer), terminal,
