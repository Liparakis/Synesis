...
/**
 * Serves the install-bundled web UI without exposing arbitrary classpath or
...
public final class StaticResourceHandler implements HttpHandler {
    ...
    private static String contentType(String resource) {
        ...
        return CONTENT_TYPES.getOrDefault(resource.substring(dot + 1).toLowerCase(java.util.Locale.ROOT),
