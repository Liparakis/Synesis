...
final class BuildInfo {
  ...
  static String text() {
    ...
    return "SYNESIS_VERSION=" + values.getProperty("version", "0.1.0-dev.local")
        ...
        + "JAVA_RUNTIME=" + values.getProperty("javaRuntime",
        Runtime.version()
            .toString());
  }
}
...
public final class VersionPlaceholderCommand implements Callable<Integer> {
   ...
   */
  public VersionPlaceholderCommand(CliRuntime runtime) {
