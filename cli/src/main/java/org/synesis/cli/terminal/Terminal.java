...
public interface Terminal {
     ...
     */
    default void stdout(String line) { out().println(line); out().flush(); }

    /**
     * Writes stdout text without adding a line.
     * @param text text content
     */
    default void stdoutRaw(String text) { out().print(text); out().flush(); }

    /**
     * Writes one line to stderr.
     * @param line line content
     */
    default void stderr(String line) { err().println(line); err().flush(); }
