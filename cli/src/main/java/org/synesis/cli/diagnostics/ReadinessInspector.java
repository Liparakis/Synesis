...
/**
 * Performs bounded, local-only readiness checks without identity creation or network connection
 * attempts.
 *
 * @since 1.0
 */
public final class ReadinessInspector {
  ...
  /**
   * Inspects runtime, profile, identity, local candidates, and QUIC class readiness without
   * networking or repair.
   *
