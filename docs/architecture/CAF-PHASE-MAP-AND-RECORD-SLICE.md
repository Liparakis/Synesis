...
frozen. `SYN-002` is DONE at CP-0075. `SYN-003` CP-W1 is verified as the
smallest workspace/bootstrap slice; implementation stops before CP-W2
networking.
...
and closed at CP-0075. SYN-003 CP-W1 is verified: it is a thin operator
composition layer for isolated profile bootstrap and local signed decision
creation. CP-W2 networking remains separately gated and is not implemented by
this checkpoint.
