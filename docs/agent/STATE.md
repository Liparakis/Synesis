...
are DONE, SYN-002 is DONE at CP-0075, SYN-003 is DONE at CP-W3, SYN-009B is
  ...
  SYN-010A is the only ACTIVE task at CP-0111;
SYN-001 is DONE at
...
implemented transport/session subproject. Public GitHub preview preparation is
blocked at the intentional-license gate until an authorized license decision
exists.
