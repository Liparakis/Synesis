...
- Active task: SYN-002 (planning only)
- Repository branch: master
- Last checkpoint: CP-0073
...
- Exact next documentation action: review ADR-0013 and the SYN-002 query
  contract; do not implement until explicitly approved.
