...
- Exact next code action: wire lane close/revocation into completion,
  cancellation, and reconciliation, then enforce current contract revisions
  and unresolved coordination requests during integration.
