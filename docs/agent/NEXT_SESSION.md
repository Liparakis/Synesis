...
- Last checkpoint: CP-0265; atomic handoff changes are ready for local commit.
...
- Exact next code action: add deterministic lease-boundary and deleted-process tests, then validate dirty-worktree handoff artifacts before advancing to contract revisions.
