...
- Exact next code action: verify provider-lifecycle lane close and grant
  revocation release paths against completion, cancellation, and reconciliation;
  then run the real-provider checklist if harness credentials and quotas permit.
