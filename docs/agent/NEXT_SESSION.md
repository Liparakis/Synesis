...
- Last checkpoint: CP-0269; the first SYN-023 compatibility slice is ready for local commit.
...
- Exact next code action: wire compatibility results into shared CLI/MCP integration-readiness adapters and preserve contract/path provenance in snapshots.
