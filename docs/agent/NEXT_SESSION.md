...
- Exact next code action: Perform the documented two-machine onboarding validation when two physical computers are available; do not claim it from process evidence.
- Unresolved blockers: physical onboarding and the remaining abrupt-loss/wrong-identity scenarios remain pending; no physical claim is permitted.
