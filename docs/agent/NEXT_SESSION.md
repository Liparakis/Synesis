...
- Exact next code action: Inventory all `workspace.application` FQNs and responsibility groups; do not make production edits until the inventory is recorded.
