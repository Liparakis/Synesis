...
- Exact next code action: add focused stale-contract and unresolved-request
  integration regressions, then verify provider-lifecycle lane close and grant
  revocation release paths before final validation.
