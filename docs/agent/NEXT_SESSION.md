...
- Last checkpoint: CP-0402. SYN-035 ten-tool lifecycle surface, strict schemas,
  ...
  SYN-036 tasks 1 through 7 are complete at commits `71b33c5`, `14ff54f`,
  `9e62c9f`, `b3b260f`, `23dea7c`, `192f839`, and the current integration-queue
  slice, with the authority-lineage and dependency-ordering tests verified.
...
- Exact next code action: implement and test atomic repair transfer: preserve
  the immutable conflict representation, materialize it into a fresh repair
  lane from current control state, and transfer reserved scope/epoch exactly
  once without an unowned interval.
