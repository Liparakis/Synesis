...
- Last checkpoint: CP-0122
- Last passing command: `gradlew.bat check --dependency-verification=strict`
- Last failing command: GitHub Windows ARM64 bundle setup could not resolve Temurin 25; fixed by using Microsoft OpenJDK 25 and Node 24-compatible action majors.
