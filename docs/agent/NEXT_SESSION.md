...
- Last checkpoint: CP-0402. SYN-035 ten-tool lifecycle surface, strict schemas,
  ...
  SYN-036 tasks 1/2/3 are complete at commits `71b33c5`, `14ff54f`, and
  `9e62c9f`.
...
- Exact next code action: implement and test reset recovery keyed by canonical
  Git common-directory identity and transaction ID, including exclusive lock,
  durable phase markers, restart discovery, and fail-closed conflicting
  journals.
