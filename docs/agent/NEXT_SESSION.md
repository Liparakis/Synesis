...
- Last checkpoint: CP-0264; owner-independent abandoned-claim recovery is ready for local commit.
...
- Exact next code action: add durable claim epochs and a two-party handoff offer/accept event; reject stale, duplicate, wrong-target, and unauthorized transfers.
