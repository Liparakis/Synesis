...
- Last checkpoint: CP-0271; raw MCP naming, readiness adapters, and provider evidence report are implemented and ready for local commit.
...
- Exact next code action: retry real Codex/Claude collaboration acceptance after correcting provider MCP configuration/auth; do not alter native-hook maturity from MCP evidence.
