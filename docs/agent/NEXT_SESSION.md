...
- Exact next code action: run the real-provider checklist if harness
  credentials and quotas permit; otherwise preserve the recorded external
  blocker and keep the deterministic acceptance as the local evidence.
