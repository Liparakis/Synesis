...
- Active task: SYN-015 ACTIVE under Reorganize Synesis package structure; `STRUCT-1C` ACTIVE following CP-0214
...
- Exact next code action: Inventory current MCP package FQNs and begin the first coherent STRUCT-1C package move after confirming the durable-state commit is clean.
