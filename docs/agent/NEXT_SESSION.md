...
- Last checkpoint: CP-0121
- Last passing command: `gradlew.bat check --dependency-verification=strict`
- Last failing command: GitHub Ubuntu `clean check` failed at the abrupt process-loss wait; fixed with a test-only short liveness policy.
