...
- Goal revision: 2
- Status: contract active; SL-012 implementation and two-process evidence complete; SL-013 frozen DONE at CP-0054; physical onboarding and remaining demo scenarios are not claimed; SL-009 deferred. SYN-001 remains blocked behind SL-014; see `docs/architecture/CAF-PHASE-MAP-AND-RECORD-SLICE.md`.
